        ...
        <Container maxWidth="lg">
          ...
          >
            ...
            >
              <Tooltip
                title={
                  auth.currentUser !== null
                    ? `Login as ${auth.currentUser?.email}`
                    : ""
                }
              >
                <AccountIconButton
              ...
              <CartIconButton
                number={cart !== null ? cart.productAndCartItemList.length : 0}
                url={auth.currentUser !== null ? "/cart" : "/"}
              />
            </div>
          </div>
          <div
          ...
          >
            <Grid container spacing={0}>
              <Grid item xs={2.5}>
                <NavButton categoryList={categoryList} isVisible={isVisible} />
              </Grid>
            </Grid>
          </div>
        </Container>
